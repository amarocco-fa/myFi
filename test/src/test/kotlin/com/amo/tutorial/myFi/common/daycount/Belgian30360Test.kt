...
class Belgian30360Test : AbstractDaycountTest(DaycountConvention.BE30360) {
    ...
    override fun definitionSample(): kotlin.Array<kotlin.Any> = JUnitParamsRunner.`$`(
            ...
            JUnitParamsRunner.`$`(AbstractDaycountTest.ONE_SEMI_REGULAR_YEAR, dividePer360(30 + 28 + 31 + 30 + 31 + 30)),
            ...
            JUnitParamsRunner.`$`(interval(AbstractDaycountTest.LEAP_YEAR, 12, 31, AbstractDaycountTest.LEAP_YEAR + 1, 1, 31), dividePer360(30 - 1)),
            JUnitParamsRunner.`$`(interval(AbstractDaycountTest.LEAP_YEAR, 12, 1, AbstractDaycountTest.LEAP_YEAR, 12, 31), dividePer360(29 + 1)),

            JUnitParamsRunner.`$`(interval(AbstractDaycountTest.REGULAR_YEAR, 2, 1, AbstractDaycountTest.REGULAR_YEAR, 2, 28), dividePer360(30)),
            JUnitParamsRunner.`$`(interval(AbstractDaycountTest.LEAP_YEAR, 2, 1, AbstractDaycountTest.LEAP_YEAR, 2, 29), dividePer360(30)),
            ...
            JUnitParamsRunner.`$`(interval(AbstractDaycountTest.LEAP_YEAR, 2, 28, AbstractDaycountTest.LEAP_YEAR, 3, 31), dividePer360(31)),

            JUnitParamsRunner.`$`(interval(AbstractDaycountTest.REGULAR_YEAR, 1, 31, AbstractDaycountTest.REGULAR_YEAR, 2, 28), dividePer360(30)),
            JUnitParamsRunner.`$`(interval(AbstractDaycountTest.LEAP_YEAR, 1, 31, AbstractDaycountTest.LEAP_YEAR, 2, 29), dividePer360(30)),
            JUnitParamsRunner.`$`(interval(AbstractDaycountTest.LEAP_YEAR, 1, 31, AbstractDaycountTest.LEAP_YEAR, 2, 28), dividePer360(29)),

            JUnitParamsRunner.`$`(interval(AbstractDaycountTest.REGULAR_YEAR, 12, 31, AbstractDaycountTest.LEAP_YEAR, 1, 31), dividePer360(29)),
            JUnitParamsRunner.`$`(interval(AbstractDaycountTest.REGULAR_YEAR, 11, 30, AbstractDaycountTest.REGULAR_YEAR, 12, 31), dividePer360(31))
    )
